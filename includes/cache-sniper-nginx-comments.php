...
class Cache_Sniper_Nginx_Comments {
  ...
  public function csnx_delete_current_page_cache_on_comments( $comment ) {
    ...
    if ( get_option( $this->get_home_page_cache_clear_on_comments_setting() ) == 1 ) {
      $this->csnx_delete_home_page_cache_on_comments();
    }
   ...
   */
  public function csnx_delete_home_page_cache_on_comments() {
